              ...
              <div className="profile-card">
                ...
                <div className="profile-copy">
                  ...
                  <div className="resume-meta">
                    <span>{info.city}, {info.province}</span>
            ...
            <div className="window-body resume-panel-body">
              <div className="timeline-list">
                {info.education.map((item) => (
                  <article className="timeline-card" key={`${item.degree}-${item.at}`}>
                    <div className="timeline-heading">
                      <div>
                        <h3>{item.degree}</h3>
                        <p>{item.field}</p>
            ...
            <div className="window-body resume-panel-body">
              <div className="contact-card">
                ...
                <div className="contact-links">
                  <a href={info.socialMedia.telegram} target="_blank" rel="noreferrer" className="contact-link">
                    <span className="contact-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24"><path d="M9.6 15.3 9.2 20c.4 0 .6-.2.8-.4l2-2 4.2 3.2c.8.4 1.3.2 1.5-.7L21 4.7c.2-.9-.3-1.3-1-1.1L2.8 10.2c-.9.3-.9.9-.2 1.1l4.7 1.5 10.9-7c.5-.3.9-.1.5.2l-8.8 8.1Z" /></svg>
                    </span>
                    Telegram
                  </a>
                  <a href={info.socialMedia.instagram} target="_blank" rel="noreferrer" className="contact-link">
                    <span className="contact-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24"><path d="M7 3h10a4 4 0 0 1 4 4v10a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V7a4 4 0 0 1 4-4Zm5 5.2A4.8 4.8 0 1 0 16.8 13 4.8 4.8 0 0 0 12 8.2Zm6.2-1.7a1.1 1.1 0 1 0 0 2.2 1.1 1.1 0 0 0 0-2.2Z" /></svg>
                    </span>
                    Instagram
                  </a>
                  <a href={info.socialMedia.github} target="_blank" rel="noreferrer" className="contact-link">
                    <span className="contact-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24"><path d="M12 2a10 10 0 0 0-3.16 19.18c.5.09.68-.22.68-.48v-1.7c-2.78.6-3.37-1.2-3.37-1.2-.46-1.15-1.12-1.46-1.12-1.46-.91-.62.07-.61.07-.61 1 .07 1.53 1.02 1.53 1.02.9 1.54 2.35 1.1 2.92.84.09-.65.35-1.1.63-1.35-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.26.1-2.63 0 0 .84-.27 2.75 1.02A9.6 9.6 0 0 1 12 6.84c.85 0 1.71.11 2.51.33 1.91-1.29 2.75-1.02 2.75-1.02.56 1.37.21 2.38.11 2.63.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.69-4.57 4.94.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0 0 12 2Z" /></svg>
                    </span>
                    GitHub
                  </a>
                </div>
        ...
        <div className="resume-grid full-width">
          <section id="projects" className="window resume-panel">
            ...
            <div className="window-body resume-panel-body">
              ...
              <Link href="/projects" className="action-link browse-all">
                {t('browseAllProjects')}
              </Link>
            </div>
          </section>
